...
echo "kan.deng@qq.com:<hash>" | sudo tee /etc/squid/passwords

# 3. Verify the credentials against the password file
echo "kan.deng@qq.com Wefew3@ha" | /usr/lib/squid/basic_ncsa_auth /etc/squid/passwords
```
...
curl --proxy-insecure -x https://droner:welcome@www.drone-navigation.com:3128 -I https://www.google.com
```
